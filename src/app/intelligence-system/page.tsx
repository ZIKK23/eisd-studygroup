...
export default function IntelligenceSystemPage() {
  ...
  const syllabus = [
    { week: "01", topic: "IoT Fundamentals" },
    { week: "02", topic: "Protocol Communications IoT and Embedded Basics" },
    { week: "03", topic: "Hands on ESP32" },
    { week: "04", topic: "Embedded System Fundamentals" },
    { week: "05", topic: "Protocol Communications IoT Specific (WiFi and Bluetooth)" },
    { week: "06", topic: "Cloud Integration" },
    { week: "07", topic: "Iot Platform Blynk" },
    { week: "08", topic: "MQTT and System Logic" },
  ];
                ...
                <div className={cn(
                    ...
                    <div className="overflow-hidden">
                        <p className="text-lg text-black max-w-2xl leading-relaxed pt-2">
                            Exploring the frontiers of Artifical Intelligence, IoT, and Data Science. Build smart, connected systems that interact with the physical world.
                        </p>
